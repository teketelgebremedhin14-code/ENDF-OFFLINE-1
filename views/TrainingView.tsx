...
import { generateExamQuestion, evaluateApplicant, draftSRSCommunication, generateCourseRecommendations, analyzeStudentRisk, generateInterventionPlan, generateCurriculumGapAnalysis } from '../services/aiService';
